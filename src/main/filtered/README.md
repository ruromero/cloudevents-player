...
```{bash}
./target/cloudevent-player-${project.version}-runner
```
...
...
2022-06-24 18:48:11,565 INFO  [io.quarkus] (main) cloudevent-player ${project.version} native (powered by Quarkus ${quarkus.platform.version}) started in 0.022s. Listening on: http://0.0.0.0:8080
